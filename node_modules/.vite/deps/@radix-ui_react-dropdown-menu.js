...
import {
  ...
  Root2,
  createPopperScope
} from "./chunk-ULNZZIVL.js";
import {
  useCallbackRef
} from "./chunk-JF65US4N.js";
import {
  Presence,
  ...
  useId
} from "./chunk-JKLQCP4Z.js";
import "./chunk-YJ3GOR4T.js";
import {
  composeRefs,
  useComposedRefs
} from "./chunk-OUJSIABN.js";
import {
  require_jsx_runtime
} from "./chunk-44NG7CLB.js";
import {
  require_react_dom
} from "./chunk-5GLTM4JM.js";
import {
  require_react
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React7.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime7.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React7.isValidElement(newElement) ? React7.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var FocusScope = React9.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime9.jsx)(Primitive2.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React10.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime10.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React10.isValidElement(newElement) ? React10.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React10.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  const Slot7 = createSlot4(`Primitive.${node}`);
...
var Slottable5 = createSlottable5("Slottable");
function isSlottable5(child) {
  return React12.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
var Primitive4 = NODES4.reduce((primitive, node) => {
  const Slot7 = createSlot5(`Primitive.${node}`);
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React25.useRef(false);
  ...
  return (0, import_jsx_runtime15.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime15.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime15.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React25.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React25.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React25.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = React25.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
...
var MenuRootContentNonModal = React25.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
  return (0, import_jsx_runtime15.jsx)(
    MenuContentImpl,
    {
...
var Slot6 = createSlot4("MenuContent.ScrollLock");
var MenuContentImpl = React25.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React25.useState(null);
    const contentRef = React25.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React25.useRef(0);
    const searchRef = React25.useRef("");
    const pointerGraceTimerRef = React25.useRef(0);
    const pointerGraceIntentRef = React25.useRef(null);
    const pointerDirRef = React25.useRef("right");
    const lastPointerXRef = React25.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React25.Fragment;
    const scrollLockWrapperProps = disableOutsideScroll ? { as: Slot6, allowPinchZoom: true } : void 0;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React25.useCallback((event) => {
    ...
    return (0, import_jsx_runtime15.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React25.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React25.useCallback(
          (event) => {
        ...
        onPointerGraceIntentChange: React25.useCallback((intent) => {
...
var MenuGroup = React25.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...groupProps } = props;
    return (0, import_jsx_runtime15.jsx)(Primitive3.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
MenuGroup.displayName = GROUP_NAME2;
var LABEL_NAME = "MenuLabel";
var MenuLabel = React25.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...labelProps } = props;
    return (0, import_jsx_runtime15.jsx)(Primitive3.div, { ...labelProps, ref: forwardedRef });
  }
);
MenuLabel.displayName = LABEL_NAME;
var ITEM_NAME2 = "MenuItem";
var ITEM_SELECT = "menu.itemSelect";
var MenuItem = React25.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React25.useState("");
    React25.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React25.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React25.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React25.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React25.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React25.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React25.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime15.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var MenuSubTrigger = React25.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React25.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React25.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React25.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React25.useEffect(() => {
...
var MenuSubContent = React25.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME, props.__scopeMenu);
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime16.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime16.jsx)(Root3, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
DropdownMenu.displayName = DROPDOWN_MENU_NAME;
var TRIGGER_NAME = "DropdownMenuTrigger";
var DropdownMenuTrigger = React26.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuContent = React26.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React26.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel = React26.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React26.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React26.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem = React26.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React26.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator = React26.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React26.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime16.jsx)(Arrow2, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var DropdownMenuSubTrigger = React26.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent = React26.forwardRef((props, forwardedRef) => {
