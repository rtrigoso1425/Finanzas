...
var PopperAnchor = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime9.jsx)(Primitive3.div, { ...anchorProps, ref: composedRefs });
  }
);
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React13.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime10.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React13.isValidElement(newElement) ? React13.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React13.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var Primitive4 = NODES4.reduce((primitive, node) => {
  const Slot5 = createSlot4(`Primitive.${node}`);
...
var Portal = React15.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime12.jsx)(Primitive4.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
//# sourceMappingURL=chunk-ULNZZIVL.js.map
