...
function Dropdown({
  ...
  return (
    <motion.div
      ...
      className="absolute top-full left-0 mt-2 min-w-[16rem] max-w-[24rem] w-full bg-popover border border-border rounded-xl shadow-lg overflow-hidden z-50">
      ...
      <div
        className="max-h-64 overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-muted-foreground/20 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-muted-foreground/30">
...
const MemberSelector = React.forwardRef((
  {
    members,
    selected,
    onChange,
